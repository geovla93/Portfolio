					...
					<Grid item container xs={12} md={6}>
						<Grid className={classes.padding} item xs={12}>
							<Typography className={classes.text} variant="body1">
								Hello, I'm George Vlassis. When I was at school, I was dreaming
								of becoming a game developer, so I started learning programming
								at a very young age. Later, I studied{" "}
